...
\begin{figure}[ht]
    \centering
    % \includegraphics[width=1.0\textwidth]{assets/charts/5_1_BackboneSelection.pgf}
    \resizebox{1.0\textwidth}{!}{\input{"assets/charts/5_1_BackboneSelection.pgf"}}
...
\begin{figure}[ht]
    \centering
    \resizebox{1.0\textwidth}{!}{\input{"assets/charts/5_2_LongTailResultComparison.pgf"}}
...
\begin{figure}[ht]
    \centering
    \resizebox{1.0\textwidth}{!}{\input{"assets/charts/5_3_AFRICANPretrainingProcess.pgf"}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{assets/charts/5_4_AttentionMaps_1}
