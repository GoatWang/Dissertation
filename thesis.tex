...
\title{Action Frame Identity Contrastive Learning (AFRICAN) For Animal Action Recognition} %TODO: change title
\subtitle{ on Animal Kingdom Dataset} %TODO: change title
\author{Hsuan-Chung, Wang}

\DTMsavedate{thesisdate}{2023-02-02}        % do not change name, will be re-used
